...
\begin{document}
	...
	\begin{minidefin}
		Los hipersímbolos figuerolianos se componen de hiperconstantes, hiperbloques, hiperdelimitadores, hipersignos y de los símbolos figuerolianos \ref{chap:symbola} REFERIR BIEN
	\end{minidefin}
